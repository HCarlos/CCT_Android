...
public class AvisoDePrivacidadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtTitulo.setText("Aviso de Privacidad");


        webView = (WebView) findViewById(R.id.webViewAP);
        webView.setWebViewClient(new AvisoDePrivacidadActivity.Callback());
        ...
        onCreateObject(AppConfig.URL_AVISODEPRIVACIDAD);
